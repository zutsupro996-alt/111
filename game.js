...
const Game = {
  ...
  async init() {
    ...
    this.mecha1 = new Mecha(1,100,GROUND_Y-MECHA_H,'#2979ff','#1565c0','#82b1ff',{up:'KeyW',down:'KeyS',left:'KeyA',right:'KeyD',attack:'Space',block:'ShiftLeft'},true);
    this.mecha2 = new Mecha(2,CANVAS_W-100-MECHA_W,GROUND_Y-MECHA_H,'#ff1744','#b71c1c','#ff8a80',{up:'ArrowUp',down:'ArrowDown',left:'ArrowLeft',right:'ArrowRight',attack:'Enter',block:'ControlLeft'},false);
